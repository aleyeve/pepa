...
import { ArrowLeft, CalendarDays, CheckCircle, XCircle, Download } from "lucide-react"
...
export function VacationManagement({
  ...
  const handleStatusChange = (id: number, newStatus: string) => {
    setVacations((prev) => prev.map((vacation) => (vacation.id === id ? { ...vacation, status: newStatus } : vacation)))
  }
